...
export const createCouponController = async (req, res) => {
    ...
    sendResponse(res, { message: "Coupon created successfully", data: newCoupon }, STATUS_CODES.CREATED);
};

export const updateCouponController = async (req, res, next) => {
    const { id } = req.params;
    const updatedCoupon = await couponService.updateCoupon(id, req.body);
    sendResponse(res, { message: "Coupon updated successfully", data: updatedCoupon }, STATUS_CODES.OK);
};
...
export const deleteCouponController = async (req, res) => {
    ...
    sendResponse(res, { message: "Coupon deleted successfully" }, STATUS_CODES.OK);
};
