...
const CouponManagement = () => {
  ...
  const currentCoupons = processedCoupons.slice(
    (page - 1) * itemsPerPage,
    page * itemsPerPage,
  );
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage active discounts and promotional codes
          </p>
        </div>
        <button
              ...
              {isLoading ? (
                ...
                currentCoupons.map((coupon) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="font-black text-emerald-800 tracking-wide uppercase">
                          {coupon.code}
                        </div>
                        <div className="text-xs text-gray-400 mt-1 truncate max-w-50">
                          {coupon.description}
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`font-medium ${isExpired ? "text-red-500" : "text-gray-600"}`}
                        >
                      ...
                      <td className="px-6 py-4 text-center">
                        <span
                          className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide inline-flex ${coupon.isActive ? "bg-emerald-100 text-emerald-700" : "bg-gray-100 text-gray-600"}`}
                        >
