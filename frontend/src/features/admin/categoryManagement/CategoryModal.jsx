...
const CategoryModal = ({ isOpen, onClose, onSubmit, initialData, isSubmitting }) => {
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto custom-scrollbar">
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-gray-50/50 rounded-xl border border-gray-100">
              ...
              >
                <div
                  className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform duration-200 flex items-center justify-center ${
        ...
        <div className="flex gap-3 px-6 py-4 border-t border-gray-100 shrink-0">
          ...
          <button
            type="submit"
            form="category-form"
            className={`flex-1 py-2.5 text-white text-sm font-bold rounded-xl transition-all shadow-md active:scale-95
