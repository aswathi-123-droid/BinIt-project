...
const LoginPage = () => {
  ...
  useEffect(() => {
    if (!loading && user) navigate("/services");
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans text-gray-800">
      ...
      <div className="h-250 bg-gray-50 flex items-center justify-center p-4 font-sans text-gray-800">
        <div className="bg-white w-full max-w-100 p-8 rounded-2xl shadow-lg border border-gray-100">
          ...
          <div className="relative flex py-2 items-center mb-6">
            ...
            <span className="shrink-0 mx-4 text-gray-400 text-xs">
