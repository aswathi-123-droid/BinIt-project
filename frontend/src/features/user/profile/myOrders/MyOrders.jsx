...
const MyOrders = () => {
    ...
    return (
      <div className="w-full max-w-5xl mx-auto p-4 sm:p-6 font-sans">
        ...
        <div className="relative mb-8">
          <div className="w-full h-12 bg-gray-100 rounded-xl animate-pulse border border-gray-200"></div>
        </div>

        <div className="flex items-center gap-8 border-b border-gray-100 mb-8 pb-3">
        ...
        <div className="space-y-4">
          {[...Array(3)].map((_, idx) => (
            ...
            >
              ...
              <div className="space-y-4">
                {[...Array(2)].map((_, itemIdx) => (
                  <div key={itemIdx} className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-xl bg-gray-200 animate-pulse shrink-0"></div>
              ...
              <div className="flex justify-between items-end gap-4 mt-4 pt-4 border-t border-gray-50">
  ...
  const getStatusFilter = (order) => {
    ...
    switch (activeTab) {
      case "Active":
        return (
          ["Placed", "Confirmed", "Shipped"].includes(s1) ||
      ...
      case "Delivered":
        return s1 === "Delivered";
      case "Cancelled":
        return s1 === "Cancelled" || s2 === "Cancelled";
      case "Returned":
        return s1 === "Returned";
      default:
        return true;
              ...
              >
                      ...
                      <div key={idx} className="flex items-center gap-4 group">
                        ...
                        <div className="grow">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            {
                              <span
                                className={`text-[10px] uppercase font-bold ${item.productId?.type == "junk" ? "text-gray-800" : " text-emerald-600"} border border-gray-200 px-1.5 rounded`}
                              >
                                {item.productId?.type}
                              </span>
                            }
                ...
                <div className="flex flex-wrap justify-between items-end gap-4 mt-4 pt-4 border-t border-gray-50">
                  <div>
                    ...
                    <p
                      className={`text-lg font-extrabold mt-0.5 ${order?.pricing?.totalAmount <= 0 ? "text-emerald-600" : "text-gray-900"}`}
                    >
