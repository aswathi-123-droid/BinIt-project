      ...
      <section className="px-6 md:px-12 py-12 md:py-20 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6 md:pr-8 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
            <button className="w-full sm:w-auto bg-emerald-500 text-white px-8 py-4 rounded-full font-bold hover:bg-emerald-600 transition-all shadow-xl shadow-emerald-500/30 active:scale-95">
              Schedule a Pickup
            </button>
            <button className="w-full sm:w-auto border-2 border-slate-900 text-slate-900 px-8 py-4 rounded-full font-bold hover:bg-slate-900 hover:text-white transition-all active:scale-95">
              Get a Quote
            </button>
          </div>
        </div>
        ...
        <div className="relative mx-auto w-full max-w-lg lg:max-w-none">
          <div className="rounded-[2.5rem] overflow-hidden shadow-2xl relative z-10">
            <img 
              src="https://images.unsplash.com/photo-1530931535970-dcb74c0531cc?w=800&auto=format&fit=crop" 
              alt="Garbage Truck" 
